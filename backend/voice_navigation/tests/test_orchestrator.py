...
from core.schemas import ActionProposal, IntentProposal, RequestClassification
...
class OrchestratorDispatchTest(unittest.TestCase):
    def build(self, category: str) -> tuple[VoiceOrchestrator, FakeNavigationInterpreter, FakeActionInterpreter]:
        ...
        return orchestrator, navigator, actor

    def test_navigation_dispatches_to_navigation_specialist(self) -> None:
        orchestrator, navigator, actor = self.build("NAVIGATION")
    ...
    def test_question_does_not_reach_navigation_specialist(self) -> None:
        orchestrator, navigator, actor = self.build("WEBSITE_QUESTION")
    ...
    def test_action_does_not_reach_navigation_specialist(self) -> None:
        orchestrator, navigator, actor = self.build("ACTION")
