    ...
    def interpret(
        ...
        response = self._client.responses.parse(
            ...
            instructions=(
                ...
                "Map 'scroll down', 'move down', or 'go lower' to SCROLL_DOWN. Map 'scroll up', "
                "'move up', or 'go higher' to SCROLL_UP. Use target small for 'a bit' and ordinary "
                "scrolling, page for 'one page' or page up/down, and edge for top/bottom. "
