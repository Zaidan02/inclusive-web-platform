        ...
        {activeTab === "POST_JOB" && (
          <form onSubmit={handleSubmit}>
            <div style={{ background: "#ffffff", borderRadius: "20px", padding: "28px", border: "1px solid #e8edf5", boxShadow: "0 1px 8px rgba(15,23,42,0.05)", marginBottom: "16px" }}>
              ...
              <Field label="Important Tasks *" hint="Select every catalogue task that is especially important for this vacancy. Important tasks receive greater scoring weight; at least one is required.">
